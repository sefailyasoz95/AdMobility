...
export default function Register() {
	...
	const onVehicleOwnerSubmit = async (data: VehicleOwnerFormValues) => {
		try {
			...
			toast.success("Registration successful! Redirecting to vehicle information page...");
	...
	const onAdvertiserSubmit = async (data: AdvertiserFormValues) => {
		try {
			...
			toast.success("Advertiser registration successful! Redirecting to dashboard...");
						...
						<div className='flex justify-center space-x-4 p-1 bg-foreground/10 dark:bg-foreground/[0.05] rounded-lg w-fit mx-auto'>
							<motion.button
								className={`px-6 py-2 rounded-md transition-all duration-300 ${
									userRole === "vehicle_owner" ? "bg-blue-500 text-white shadow-md" : "hover:bg-foreground/5"
								}`}
							...
							<motion.button
								className={`px-6 py-2 rounded-md transition-all duration-300 ${
									userRole === "advertiser" ? "bg-teal-500 text-white shadow-md" : "hover:bg-foreground/5"
								}`}
						...
						{userRole === "vehicle_owner" ? (
							<motion.div
								...
								<Form {...vehicleOwnerForm}>
									<form onSubmit={vehicleOwnerForm.handleSubmit(onVehicleOwnerSubmit)} className='space-y-6'>
										{/* Personal Information */}
										<div className='space-y-4'>
											<h3 className='text-xl font-semibold text-blue-600 dark:text-blue-400'>Personal Information</h3>
							...
							<motion.div key='advertiser-form' variants={tabVariants} initial='hidden' animate='visible' exit='exit'>
								<Form {...advertiserForm}>
									<form onSubmit={advertiserForm.handleSubmit(onAdvertiserSubmit)} className='space-y-6'>
										{/* Personal Information */}
										<div className='space-y-4'>
											<h3 className='text-xl font-semibold text-teal-600 dark:text-teal-400'>Personal Information</h3>
										...
										<div className='space-y-4 pt-4 border-t border-foreground/10'>
											<h3 className='text-xl font-semibold text-teal-600 dark:text-teal-400'>Company Information</h3>
														...
														<FormItem>
															...
															<Select onValueChange={field.onChange} defaultValue={field.value}>
																...
																<SelectContent className='bg-popover border border-border shadow-md'>
																	...
																	<SelectItem value='entertainment' className='cursor-pointer hover:bg-muted'>
																		Entertainment
																	</SelectItem>
																	<SelectItem value='food' className='cursor-pointer hover:bg-muted'>
																		Food & Beverage
																	</SelectItem>
						...
						<p className='text-sm text-foreground/70'>
							...
							<Link
								...
								className={`font-medium hover:underline ${
									userRole === "vehicle_owner" ? "text-blue-500" : "text-teal-500"
								}`}>
								Log in
							</Link>
						</p>
