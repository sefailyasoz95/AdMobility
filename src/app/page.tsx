					...
					<div className='grid md:grid-cols-2 gap-12 items-center'>
						<motion.div
							...
							<h1 className='text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight'>
								<span className='text-foreground'>Turn Your Vehicle Into A </span>
								<span className='bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400'>
									Revenue Stream
								</span>
							</h1>
							<p className='text-lg md:text-xl text-foreground/80 max-w-xl'>
								AdMobility connects vehicle owners with advertisers, allowing you to earn money by displaying ads on
								your vehicle.
							</p>
			...
			<section className='py-16 md:py-24'>
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
					<motion.div
						...
						<h2 className='text-3xl md:text-4xl font-bold mb-4'>How AdMobility Works</h2>
						...
						{[
							{
								...
								description: "Sign up and enter your vehicle details including make, model, year, and average mileage.",
								icon: <ProfileSvg />,
								delay: 0,
							},
							{
								title: "Receive Ad Offers",
								description: "Get offers from advertisers looking to place ads on vehicles like yours.",
								icon: <OfferSvg />,
								delay: 0.2,
							},
							{
								title: "Earn Money",
								description: "Accept offers, display ads on your vehicle, and earn money while you drive.",
								icon: <EarnMoneySvg />,
								delay: 0.4,
							},
						].map((item, index) => (
							<motion.div
								...
								className='flex flex-col items-center p-6 bg-foreground/5 dark:bg-foreground/[0.03] rounded-xl hover:shadow-md transition-all duration-300'>
								<div className='h-16 w-16 mb-4 text-blue-500'>{item.icon}</div>
			...
			<section className='py-16 md:py-24 bg-foreground/[0.02] dark:bg-foreground/[0.01]'>
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
					<motion.div
						...
						<p className='text-lg text-foreground/70 max-w-2xl mx-auto'>
							AdMobility provides a seamless experience for both vehicle owners and advertisers
						</p>
					</motion.div>
								...
								{[
									{
										...
										description: "Create and manage your profile with vehicle details and availability status.",
									},
									{
										title: "Flexible Offer System",
										description: "Accept or reject offers based on your preferences and requirements.",
									},
									{
										title: "Simple Photo Verification",
										description: "Upload daily photos of your vehicle to verify ad placement and get paid.",
									},
									{
										title: "Mileage Tracking",
										description: "Track your daily and monthly mileage to meet advertiser requirements.",
									},
								].map((feature, index) => (
								...
								{[
									{
										...
										description: "Find and select vehicles based on location, vehicle type, and mileage.",
									},
									{
										title: "Campaign Management",
										description: "Create and manage ad campaigns with customizable terms and conditions.",
									},
									{
										title: "Verification System",
										description: "Verify ad placement through daily photo uploads from vehicle owners.",
									},
									{
										title: "Secure Payment Processing",
										description: "Make secure upfront payments that are only released after verification.",
									},
								].map((feature, index) => (
									<div key={index} className='flex gap-4'>
					...
					<motion.div
						...
						<div className='relative py-12 px-6 md:py-16 md:px-12 text-center text-white'>
							...
							<p className='text-lg md:text-xl mb-8 max-w-2xl mx-auto'>
								Join AdMobility today and turn your daily commute into a revenue stream.
							</p>
				...
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
					<div className='grid grid-cols-2 md:grid-cols-4 gap-8'>
						...
						<div>
							...
							<ul className='space-y-2'>
								<li>
									<Link href='/owner-signup' className='text-foreground/70 hover:text-foreground transition-colors'>
										Sign Up
									</Link>
								</li>
								<li>
									<Link href='/owner-faq' className='text-foreground/70 hover:text-foreground transition-colors'>
										FAQ
									</Link>
								</li>
								<li>
									<Link href='/owner-resources' className='text-foreground/70 hover:text-foreground transition-colors'>
										Resources
									</Link>
								</li>
							</ul>
						...
						<div>
							...
							<ul className='space-y-2'>
								...
								<li>
									<Link href='/advertiser-faq' className='text-foreground/70 hover:text-foreground transition-colors'>
										FAQ
									</Link>
								</li>
								<li>
	...
	<svg
		...
		<g className='animate-float'>
			...
			<path
				...
				fillOpacity='0.05'
			/>
			<path d='M240 340H560' stroke='currentColor' strokeWidth='2' strokeDasharray='8 8' />
			<path d='M240 360H560' stroke='currentColor' strokeWidth='2' strokeDasharray='8 8' />
			<circle cx='220' cy='400' r='40' fill='currentColor' fillOpacity='0.2' stroke='currentColor' strokeWidth='2' />
			<circle cx='220' cy='400' r='20' fill='currentColor' fillOpacity='0.4' />
			<circle cx='580' cy='400' r='40' fill='currentColor' fillOpacity='0.2' stroke='currentColor' strokeWidth='2' />
			...
			<path
				...
				strokeWidth='2'
			/>
			<rect x='300' y='320' width='200' height='40' rx='4' fill='#3B82F6' fillOpacity='0.7' />
			<text x='400' y='345' textAnchor='middle' fill='white' fontWeight='bold' fontSize='16'>
				ADMOBILITY
			</text>
		</g>
	</svg>
