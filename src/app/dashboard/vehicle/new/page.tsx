...
import { Car, Info, MapPin, Calendar, Camera, Upload, CheckCircle2 } from "lucide-react";
	...
	return (
		<div className='max-w-5xl mx-auto py-10 px-4 sm:px-6'>
			...
			<div className='mb-10 text-center'>
				<h1 className='text-3xl font-bold tracking-tight mb-2'>Register Your Vehicle</h1>
				<p className='text-muted-foreground'>
					Provide details about your vehicle to start receiving advertising offers
				</p>
			</div>
				...
				<div className='flex items-center justify-center mb-8'>
					{steps.map((step, index) => (
						<div key={step.id} className='flex items-center'>
							<div
								className={`
									flex flex-col items-center ${index > 0 ? "ml-4 sm:ml-8" : ""}
								`}>
								<div
									className={`
						...
						<motion.div
							...
							<Card className='border-0 shadow-lg overflow-hidden'>
								<CardHeader className='bg-gradient-to-r from-blue-600/5 to-teal-500/5 border-b'>
									...
									<CardDescription>Tell us how you use your vehicle</CardDescription>
								</CardHeader>
								<CardContent className='p-6 space-y-6'>
									<div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
										<FormField
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormDescription>How many miles do you drive on average per day?</FormDescription>
													<FormMessage />
												</FormItem>
											)}
										/>
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormDescription>Where do you primarily drive your vehicle?</FormDescription>
													<FormMessage />
												</FormItem>
											)}
										/>
						...
						<motion.div
							...
							<Card className='border-0 shadow-lg overflow-hidden'>
								<CardHeader className='bg-gradient-to-r from-blue-600/5 to-teal-500/5 border-b'>
									...
									<CardDescription>Upload a clear photo of your vehicle</CardDescription>
								</CardHeader>
										...
										<div className='border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-lg p-6 text-center hover:border-blue-400 dark:hover:border-blue-500 transition-all'>
											...
											{imagePreview ? (
												...
												<label
													...
													<p className='text-sm text-muted-foreground'>Upload a clear photo of your vehicle</p>
													<p className='text-xs text-muted-foreground mt-2'>PNG, JPG or JPEG (max. 10MB)</p>
												</label>
											)}
										</div>
